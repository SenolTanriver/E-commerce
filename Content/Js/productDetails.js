            ...
            if (id) {
                fetch(Filter.Apis.products + id)
                    ...
                    .then(res => {
                        ...
                        Filter.Elements.price.innerText ="Fiyat: "+ res.price + " TL";
                        Filter.Elements.rating.innerText ="Puan: "+ res.rating;
                        Filter.Elements.stock.innerText ="Stok: "+ res.stock;
                        Filter.Elements.discountPercentage.innerText ="İndirim oranı: "+ res.discountPercentage;
